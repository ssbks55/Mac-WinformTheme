...
namespace xThemes
{
    ...
    public class FadeForm : Form
    {
        ...
        const int AW_HOR_POSITIVE = 0X1; //Horizontal
        const int AW_HOR_NEGATIVE = 0X2;
        const int AW_VER_POSITIVE = 0X4; //Vertical
        ...
        {
            base.OnLoad(e);
            AnimateWindow(this.Handle, 1000, AW_ACTIVATE | (_UseSlideAnimation ? AW_HOR_POSITIVE | AW_CENTER : AW_BLEND));
        }
